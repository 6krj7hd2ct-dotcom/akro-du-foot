...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .global-controls {{ display: flex; flex-direction: row; flex-wrap: nowrap; gap: 16px; align-items: center; justify-content: space-between; width: 100%; max-width: min(1040px, 100%); }}
    ...
    .global-search {{ position: relative; flex: 1 1 auto; min-width: 0; max-width: none; }}
